  ...
  <div v-bind="resolvedAttrs.wrapperAttrs.wrapper1">
    <div v-bind="resolvedAttrs.wrapperAttrs.wrapper2">
      <input :id="id" type="radio" :name="name" :value="value" :checked="modelValue === value"
        @change="$emit('update:modelValue', value)" v-bind="resolvedAttrs.inputAttrs" />
  ...
  wrappers: [
    {
      ...
      addClass: props.version === 'dashboard' ? 'flex flex-col gap-2' :
    ...
    },
    {
      ...
      addClass: props.version === 'dashboard' ? 'flex items-center gap-2 relative' :
