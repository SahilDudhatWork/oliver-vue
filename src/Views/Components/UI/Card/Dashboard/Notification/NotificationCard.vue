...
const palettes = {
  notice: {
    ...
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(34,204,238,0.15)_0,rgba(34,204,238,0.15)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(34,204,238,0.15)_0,rgba(34,204,238,0.15)_100%),rgba(26,32,44,0.9)]",
  ...
  alert: {
    left: "bg-[#FDB022] dark:bg-[#FDB022]",
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(253,176,34,0.15)_0,rgba(253,176,34,0.15)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(253,176,34,0.15)_0,rgba(253,176,34,0.15)_100%),rgba(26,32,44,0.9)]",
    title: "text-[#FDB022] dark:text-[#FDB022]",
    link: "text-[#FDB022] dark:text-[#FDB022]",
    iconBg: "bg-[rgba(253,176,34,0.15)] dark:bg-[rgba(253,176,34,0.15)]",
    iconStroke: "stroke-[#FDB022] text-[#FDB022]",
  },
  success: {
    left: "bg-[#07f468] dark:bg-[#07f468]",
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(7,244,104,0.15)_0,rgba(7,244,104,0.15)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(7,244,104,0.15)_0,rgba(7,244,104,0.15)_100%),rgba(26,32,44,0.9)]",
    title: "text-[#07f468] dark:text-[#07f468]",
    link: "text-[#07f468] dark:text-[#07f468]",
  ...
  error: {
    ...
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(255,68,5,0.12)_0,rgba(255,68,5,0.12)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(255,68,5,0.12)_0,rgba(255,68,5,0.12)_100%),rgba(26,32,44,0.9)]",
  ...
  warning: {
    left: "bg-[#FF4405] dark:bg-[#FF4405]",
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(255,68,5,0.10)_0,rgba(255,68,5,0.10)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(201,51,0,0.10)_0,rgba(201,51,0,0.10)_100%),rgba(26,32,44,0.9)]",
    title: "text-[#FF4405] dark:text-[#FF4405]",
    link: "text-[#FF4405] dark:text-[#FF4405]",
  ...
  info: {
    ...
    bg: "[background:linear-gradient(90deg,rgba(255,255,255,0)_0,rgba(255,255,255,0.9)_100%),linear-gradient(0deg,rgba(59,130,246,0.12)_0,rgba(59,130,246,0.12)_100%),rgba(255,255,255,0.9)] dark:[background:linear-gradient(90deg,rgba(26,32,44,0)_0,rgba(26,32,44,0.9)_100%),linear-gradient(0deg,rgba(59,130,246,0.12)_0,rgba(59,130,246,0.12)_100%),rgba(26,32,44,0.9)]",
